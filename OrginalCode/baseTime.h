...
class Time
{
	...
	public:
		...
		{
			m_timeSpec.tv_nsec += (delay*1000000L);
			m_timeSpec.tv_sec += (m_timeSpec.tv_nsec/1000000000L);
			m_msec = sec()*1000L + m_timeSpec.tv_nsec/1000000L;
			m_tmOk = false;
		}
		...
		{
			time_t timValue = timeVal - s_myTimeSync - s_myTimeZone;
			gmtime_r(&timValue,&tmVal);
		}
